...
/**
 * ourTeam/opponentTeam: { name }
 * ourWinChance: number (0~100)
 * ourTeam.avgWinRate20, opponentTeam.avgWinRate20: 최근 20게임 승률 (표시용)
 */
  ...
  return (
    <div className="predict-box">
      <div className="pv-team">
        ...
        <EmptyImageBox className="avatar-frame" label="TEAM" style={{ margin: '0 auto 12px' }} />
        <div className="tname display">{ourTeam.name}</div>
      </div>
      <div className="pv-center">
        <div className="pv-label">예상 승률</div>
        <div className="pv-percent" style={{ color: 'var(--win)' }}>{ourWinChance}%</div>
        <div className="pv-vs-bar">
          <div className="a" style={{ width: `${ourWinChance}%` }} />
          <div className="b" style={{ width: `${theirWinChance}%` }} />
        </div>
        <div className="pv-percent" style={{ color: 'var(--lose)', fontSize: 20 }}>{theirWinChance}%</div>
