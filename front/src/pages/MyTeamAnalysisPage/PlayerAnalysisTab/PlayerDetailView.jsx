  ...
  return (
    <>
      <div className="user-select">
        👤 <b style={{ color: 'var(--text-1)' }}>{player.name} #{player.tag}</b> 선택됨 — <span onClick={onBack} style={{ cursor: 'pointer' }}>다른 선수 보기 ▾</span>
      </div>
      ...
      <div className="analysis-row">
        ...
        <div className="aim-dual">
          <div>
            ...
            <EmptyImageBox
              className="hitbox-img"
              label={`히트박스 이미지\n영역 (부위별 타격률 오버레이)`}
              style={{ width: '100%', height: 190 }}
            />
            <div className="hitzone-list" style={{ marginTop: 14 }}>
              {aim.hitzones.map((h) => (
          ...
          <div>
            ...
            {aim.weapons.map((w) => (
              <div className="weapon-row" key={w.name}>
                <EmptyImageBox className="weapon-icon" label={`${w.name}\nICON`} />
