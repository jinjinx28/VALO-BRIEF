    ...
    <div className="summary-strip">
      ...
      <div>
        ...
        <div className="summary-wl">
          <span><span className="dot" style={{ background: 'var(--win)' }} />{recentSummary.wins}승</span>
          <span><span className="dot" style={{ background: 'var(--lose)' }} />{recentSummary.losses}패</span>
        </div>
      </div>
