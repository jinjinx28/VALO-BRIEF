  ...
  return (
    <div className="auth-col">
      ...
      <div className="auth-title display">
        팀 정보 등록하기 <span className="step-label">STEP 2 / 2</span>
      </div>
      <div className="field">
        <input value={form.teamName} onChange={(e) => onChange('teamName', e.target.value)} placeholder="team - name" />
      </div>
      <div className="field">
