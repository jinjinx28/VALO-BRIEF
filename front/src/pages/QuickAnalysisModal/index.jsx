        ...
        <div className="popup-body">
          <div className="p-box">
            ...
            <div className="p-stats-row">
              ...
              <span>승률<b style={{ color: 'var(--lose)' }}>{data.winRate}%</b></span>
          ...
          <div className="p-box">
            ...
            <div className="tier-row">
              <EmptyImageBox className="tier-badge-img" label={`TIER\nICON\nIMAGE`} />
              ...
              <div className="barplot-wrap">
                ...
                <span style={{ fontSize: 11, color: 'var(--text-2)' }}>상위 {data.tier.topPercent}%</span>
              </div>
            </div>
          </div>

          <div className="p-box" style={{ marginBottom: 0 }}>
